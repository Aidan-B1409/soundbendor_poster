% SoundBendOR beamerposter template
% Derived from Gemini theme: https://github.com/anishathalye/gemini


% OSU Color Branding Standards
...
% Options: Black, Orange, Luminance
% Will update header colors and logos.
\headercolor{Orange}
